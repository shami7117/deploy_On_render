from flask import Flask, request, render_template, send_file, session, redirect, url_for,send_from_directory
...
def favicon():
    # Make sure you have a static folder at the root level with favicon.ico in it
